...
- Обновлен профиль:
  ...
  - выбор региона/города из списка (поиск),
  - кнопки сброса города/области,
  - debounce поиска (300ms),
  - корректная передача `null` при сбросе.
...
- `python_backend/tests/test_locations_leaderboard.py` проходит (7 тестов).
